...
class Handler extends ExceptionHandler
{
    ...
    /**
     * Render an API exception into an HTTP response.
     *
     * @param  \Exception  $exception
     * @return \Illuminate\Http\Response
     */
    public function apiException($exception)
    {
        ...
        if ($exception instanceof PDOException) {
            return $this->errorResponse(App::environment('local') ? $exception->getMessage() : 'Database error', 500);
        }
    ...
    /**
     * Builds and returns a json response with an error message
